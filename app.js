  ...
  helmet.contentSecurityPolicy({
    directives: {
      ...
      imgSrc: [
        ...
        "blob:",
        "data:",
        "https://res.cloudinary.com/ren-camp/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT!
...
app.use("/", userRoutes);
app.use("/products", productRoutes); //inside products routes all routes starting from /products.
app.use("/products/:id/reviews", reviewRoutes); //inside reviews routes all routes starting from /products/:id/reviews
...
const port = 3000; //process.env.PORT will be automatically present on heroku
app.listen(port, () => {
